...
--------------------------
Warning
Most of the modules using messaging framework (ex. Notifications) send messages at cron job instead of immediately. Therefore there can be 2 or more messages 
sent for 1 user at the same time which doesn’t make sense in Voip case, because user can’t answer the phone call twice. 
